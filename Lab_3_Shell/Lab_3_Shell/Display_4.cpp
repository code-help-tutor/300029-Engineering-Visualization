...
void Display_4::Draw(int *viewing)
{
	//// Section 1 ///////////////////////////////////////////////
	...
	*viewing = 3; // Decide the display method: 2 = 2D display; 3 = 3D orthogonal parallel projection; 4 = 3D perspective projection;
	...
	gluLookAt(x0, y0, z0, xref, yref, zref, Vx, Vy, Vz); // For perspective projection
...
*/
void Display_4::transform3D(double r11, double r12, double r13, double tx,
